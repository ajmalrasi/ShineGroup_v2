package com.ajmalrasi.shinegroup.chat.gcm;
    ...
    private void processChatRoomPush(String title, boolean isBackground, String data) {
        if (!isBackground) {
            ...
            try {
                ...
                if (uObj.getString("member_id").equals(AppController.getInstance().getPrefManager().getMember().getId())) {
                ...
                if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
                    ...
                    pushNotification.putExtra("chat_id", chatRoomId);
                    ...
                    resultIntent.putExtra("chat_id", chatRoomId);
                    showNotificationMessage(getApplicationContext(), title, member.getName() + " : " + message.getMessage(), message.getCreatedAt(), resultIntent);
                }
