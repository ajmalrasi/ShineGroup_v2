package com.ajmalrasi.shinegroup.chat.adapter;

/**
 * Created by Rasi on 07-02-2018.
 */
...
public class ChatThreadAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public int getItemViewType(int position) {
        ...
        if (message.getMember().getId().equals(userId)) {
            return SELF;
        }
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        if (message.getMember().getName() != null)
            timestamp = message.getMember().getName() + ", " + timestamp;
