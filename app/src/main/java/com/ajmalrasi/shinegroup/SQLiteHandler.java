...
public class SQLiteHandler extends SQLiteOpenHelper {
    ...
    // Login table name
    private static final String TABLE_USER = "members";
     ...
     */
    public void addUser(String name, String email, String uid, String dp, String phone) {
//    public void addUser(String name, String email, String uid, String created_at) {
        ...
        values.put(KEY_DP, dp); // Display Picture
    ...
    public HashMap<String, String> getUserDetails() {
        ...
        if (cursor.getCount() > 0) {
            ...
            user.put(KEY_DP, cursor.getString(4));
